...
import { fetchProduct } from '../providers/ProductActions'
...
const ProductPage = () => {
  ...
  return (
    <Container sx={{padding: "80px 0px"}}>
    <Card sx={{padding: "20px" , display: "flex" , minHeight: "80vh"}}>
      <img style={{height: "400px" , objectFit: "contain", width: "50%"}}
      src={product?.image}
      />
    ...
    <Typography variant='h4' gutterBottom>{product?.title}</Typography>
      ...
      <Chip sx={{margin: "10px 0px"}} label={product?.category} variant="outlined" />
